...
describe("UserRouter", () => {
  ...
  describe(`"POST:${Paths.Users.Add}"`, () => {
    ...
    const callApi = (reqBody: TReqBody) =>
      agent.post(Paths.Users.Add).type("form").send(reqBody);
  ...
  describe(`"PUT:${Paths.Users.Update}"`, () => {
    ...
    const callApi = (reqBody: TReqBody) =>
      agent.put(Paths.Users.Update).type("form").send(reqBody);
  ...
  describe(`"DELETE:${Paths.Users.Delete}"`, () => {
    ...
    const callApi = (id: number) =>
      agent.delete(insertUrlParams(Paths.Users.Delete, { id }));
